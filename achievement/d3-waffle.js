function d3waffle() {
    ...
    function chart(selection) {
      ...
      selection.each(function(data) {
        ...
        var idcontainer = selection._groups[0][0].id;
        // console.log(idcontainer);
        let total = d3.sum(data, function(d) { return d[1]; });
        // console.log(total);
  
        /* updating data */
        data.forEach(function(d, i){
          data[i].class = slugify(d[0]);
          // console.log(d[1]);
          // console.log(total);
          data[i].scalevalue = Math.round(d[1]/total*100);
          data[i].percent = d[1]/total;
        });
        ...
        data.forEach(function(d, i){
          ...
          d3.range(d.scalevalue).forEach(function(e){
            // console.log(e);
            detaildata.push({ name: d[0], class: d.class })
          });
        });
        // console.log(data);
        ...
        function mouseover(e, d){
          ...
          // console.log(d.fromElement.__data__.name);
          // console.log(d);
          // console.log(data);
